            ...
            <div class="card-body p-3 p-md-4 p-xl-5">
              ...
              <form action="Registration.php" method="post">
                <div class="row gy-3 overflow-hidden">
                  ...
                  <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" name="lname" id="lastName" placeholder="First Name" required>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end mt-4">
                    <p class="m-0 text-secondary text-center">Already have an account? <a href="Login.php" class="link-success text-decoration-none">Sign in</a></p>
                  </div>
                </div>
              </div>
              <div class="row">
